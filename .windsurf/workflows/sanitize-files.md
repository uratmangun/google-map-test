...
Scan files or directories for sensitive data and replace them with placeholders.

The user will specify a target file or directory. If none is provided, ask them what to scan.

1. Check if the target is a file or a directory.

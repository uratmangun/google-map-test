...
export const metadata: ToolMetadata = {
  ...
  description:
    "Render an embedded Google Map directions preview from point A to point B. Returns mapUrl (opens in Google Maps) in TOON; embedUrl powers the iframe widget.",
  annotations: {

...
import type { StreetViewToolPayload } from "../../lib/google-maps/show-street-view-payload";
...
import { schema as showStreetViewSchema } from "../../lib/mcp/show-street-view-tool";

type ShowStreetViewInput = InferSchema<typeof showStreetViewSchema>;
...
function resolvePayload(
  props: ShowStreetViewInput &
    Partial<StreetViewToolPayload & { embedUrl?: string }>,
  toolOutput: unknown,
): StreetViewToolPayload | { error: string } | null {
...
function EmbeddedStreetView({ mapUrl }: { mapUrl: string }) {
  return (
    <iframe
      src={mapUrl}
      title="Street View"
...
export default function showStreetView(
  props: ShowStreetViewInput &
    Partial<StreetViewToolPayload & { embedUrl?: string }>,
) {
  ...
  return <EmbeddedStreetView mapUrl={resolved.mapUrl} />;
}
